...
#[doc = "Values that can be written to the field `rtc_cmpr0`"]
pub enum RTC_CMPR0W {}
impl RTC_CMPR0W {
    #[allow(missing_docs)]
    #[doc(hidden)]
...
#[doc = r" Proxy"]
pub struct _RTC_CMPR0W<'a> {
    w: &'a mut W,
}
impl<'a> _RTC_CMPR0W<'a> {
    #[doc = r" Writes `variant` to the field"]
    #[inline]
    pub fn variant(self, variant: RTC_CMPR0W) -> &'a mut W {
        {
            self.bit(variant._bits())
        }
    }
...
#[doc = "Values that can be written to the field `rtc_cmpr1`"]
pub enum RTC_CMPR1W {}
impl RTC_CMPR1W {
    #[allow(missing_docs)]
    #[doc(hidden)]
...
#[doc = r" Proxy"]
pub struct _RTC_CMPR1W<'a> {
    w: &'a mut W,
}
impl<'a> _RTC_CMPR1W<'a> {
    #[doc = r" Writes `variant` to the field"]
    #[inline]
    pub fn variant(self, variant: RTC_CMPR1W) -> &'a mut W {
        {
            self.bit(variant._bits())
        }
    }
...
#[doc = "Values that can be written to the field `rtc_prescale_cmp`"]
pub enum RTC_PRESCALE_CMPW {}
impl RTC_PRESCALE_CMPW {
    #[allow(missing_docs)]
    #[doc(hidden)]
    #[inline]
    pub fn _bits(&self) -> bool {
...
#[doc = r" Proxy"]
pub struct _RTC_PRESCALE_CMPW<'a> {
    w: &'a mut W,
}
impl<'a> _RTC_PRESCALE_CMPW<'a> {
    #[doc = r" Writes `variant` to the field"]
    #[inline]
    pub fn variant(self, variant: RTC_PRESCALE_CMPW) -> &'a mut W {
        {
            self.bit(variant._bits())
        }
    }
...
#[doc = "Values that can be written to the field `rtc_rollover`"]
pub enum RTC_ROLLOVERW {}
impl RTC_ROLLOVERW {
    #[allow(missing_docs)]
    #[doc(hidden)]
    #[inline]
...
#[doc = r" Proxy"]
pub struct _RTC_ROLLOVERW<'a> {
    w: &'a mut W,
}
impl<'a> _RTC_ROLLOVERW<'a> {
    #[doc = r" Writes `variant` to the field"]
    #[inline]
    pub fn variant(self, variant: RTC_ROLLOVERW) -> &'a mut W {
        {
            self.bit(variant._bits())
        }
    }
...
impl W {
    ...
    #[doc = "Bit 12 - Mask for RTC compare 0 event"]
    #[inline]
    pub fn rtc_cmpr0(&mut self) -> _RTC_CMPR0W {
        _RTC_CMPR0W { w: self }
    }
    #[doc = "Bit 13 - Mask for RTC compare 1 event"]
    #[inline]
    pub fn rtc_cmpr1(&mut self) -> _RTC_CMPR1W {
        _RTC_CMPR1W { w: self }
    }
    #[doc = "Bit 14 - Mask for RTC prescale compare event"]
    #[inline]
    pub fn rtc_prescale_cmp(&mut self) -> _RTC_PRESCALE_CMPW {
        _RTC_PRESCALE_CMPW { w: self }
    }
    #[doc = "Bit 15 - Mask for RTC rollover event"]
    #[inline]
    pub fn rtc_rollover(&mut self) -> _RTC_ROLLOVERW {
        _RTC_ROLLOVERW { w: self }
    }
    #[doc = "Bit 16 - Mask for USB plug connect event"]
    #[inline]
