...
#[doc = "Possible values of the field `tx_start`"]
...
impl TX_STARTR {
    ...
    pub fn bit(&self) -> bool {
        match *self {
            TX_STARTR::_Reserved(bits) => bits,
        }
    }
    #[allow(missing_docs)]
    #[doc(hidden)]
    #[inline]
    pub fn _from(value: bool) -> TX_STARTR {
        match value {
            i => TX_STARTR::_Reserved(i),
        }
    }
}
#[doc = "Possible values of the field `tx_in_progress`"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum TX_IN_PROGRESSR {
    #[doc = r" Reserved"]
    _Reserved(bool),
}
impl TX_IN_PROGRESSR {
    ...
    pub fn bit(&self) -> bool {
        match *self {
            TX_IN_PROGRESSR::_Reserved(bits) => bits,
        }
    }
    #[allow(missing_docs)]
    #[doc(hidden)]
    #[inline]
    pub fn _from(value: bool) -> TX_IN_PROGRESSR {
        match value {
            i => TX_IN_PROGRESSR::_Reserved(i),
        }
    }
}
...
#[doc = "Values that can be written to the field `tx_start`"]
pub enum TX_STARTW {}
impl TX_STARTW {
    #[allow(missing_docs)]
    #[doc(hidden)]
...
#[doc = r" Proxy"]
pub struct _TX_STARTW<'a> {
    w: &'a mut W,
}
impl<'a> _TX_STARTW<'a> {
    #[doc = r" Writes `variant` to the field"]
    #[inline]
    pub fn variant(self, variant: TX_STARTW) -> &'a mut W {
        {
...
impl R {
    ...
    #[inline]
    pub fn tx_start(&self) -> TX_STARTR {
        TX_STARTR::_from({
            const MASK: bool = true;
            const OFFSET: u8 = 0;
...
impl W {
    ...
    #[doc = "Bit 0 - Start Transaction"]
    #[inline]
    pub fn tx_start(&mut self) -> _TX_STARTW {
        _TX_STARTW { w: self }
    }
}
