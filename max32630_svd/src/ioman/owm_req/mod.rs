...
#[doc = "Possible values of the field `epu_io_req`"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum EPU_IO_REQR {
    #[doc = r" Reserved"]
    _Reserved(bool),
}
impl EPU_IO_REQR {
    ...
    pub fn bit(&self) -> bool {
        match *self {
            EPU_IO_REQR::_Reserved(bits) => bits,
        }
    }
    #[allow(missing_docs)]
    #[doc(hidden)]
    #[inline]
    pub fn _from(value: bool) -> EPU_IO_REQR {
        match value {
            i => EPU_IO_REQR::_Reserved(i),
        }
    }
}
...
#[doc = "Values that can be written to the field `epu_io_req`"]
pub enum EPU_IO_REQW {}
impl EPU_IO_REQW {
    #[allow(missing_docs)]
    #[doc(hidden)]
    #[inline]
...
#[doc = r" Proxy"]
pub struct _EPU_IO_REQW<'a> {
    w: &'a mut W,
}
impl<'a> _EPU_IO_REQW<'a> {
    #[doc = r" Writes `variant` to the field"]
    #[inline]
    pub fn variant(self, variant: EPU_IO_REQW) -> &'a mut W {
        {
            self.bit(variant._bits())
        }
    }
...
impl R {
    ...
    #[inline]
    pub fn epu_io_req(&self) -> EPU_IO_REQR {
        EPU_IO_REQR::_from({
            const MASK: bool = true;
            const OFFSET: u8 = 5;
            ((self.bits >> OFFSET) & MASK as u32) != 0
...
impl W {
    ...
    #[doc = "Bit 5 - External Pullup Control Line I/O Request"]
    #[inline]
    pub fn epu_io_req(&mut self) -> _EPU_IO_REQW {
        _EPU_IO_REQW { w: self }
    }
}
