...
#[doc = "Possible values of the field `ss3_io_req`"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum SS3_IO_REQR {
    #[doc = r" Reserved"]
    _Reserved(bool),
}
impl SS3_IO_REQR {
    ...
    pub fn bit(&self) -> bool {
        match *self {
            SS3_IO_REQR::_Reserved(bits) => bits,
        }
    }
    #[allow(missing_docs)]
    #[doc(hidden)]
    #[inline]
    pub fn _from(value: bool) -> SS3_IO_REQR {
        match value {
            i => SS3_IO_REQR::_Reserved(i),
        }
    }
}
#[doc = "Possible values of the field `ss4_io_req`"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum SS4_IO_REQR {
    #[doc = r" Reserved"]
    _Reserved(bool),
}
impl SS4_IO_REQR {
    ...
    pub fn bit(&self) -> bool {
        match *self {
            SS4_IO_REQR::_Reserved(bits) => bits,
        }
    }
    #[allow(missing_docs)]
    #[doc(hidden)]
    #[inline]
    pub fn _from(value: bool) -> SS4_IO_REQR {
        match value {
            i => SS4_IO_REQR::_Reserved(i),
        }
    }
}
...
#[doc = "Values that can be written to the field `ss3_io_req`"]
pub enum SS3_IO_REQW {}
impl SS3_IO_REQW {
    #[allow(missing_docs)]
    #[doc(hidden)]
    #[inline]
...
#[doc = r" Proxy"]
pub struct _SS3_IO_REQW<'a> {
    w: &'a mut W,
}
impl<'a> _SS3_IO_REQW<'a> {
    #[doc = r" Writes `variant` to the field"]
    #[inline]
    pub fn variant(self, variant: SS3_IO_REQW) -> &'a mut W {
        {
            self.bit(variant._bits())
        }
    }
...
#[doc = "Values that can be written to the field `ss4_io_req`"]
pub enum SS4_IO_REQW {}
impl SS4_IO_REQW {
    #[allow(missing_docs)]
    #[doc(hidden)]
    #[inline]
...
#[doc = r" Proxy"]
pub struct _SS4_IO_REQW<'a> {
    w: &'a mut W,
}
impl<'a> _SS4_IO_REQW<'a> {
    #[doc = r" Writes `variant` to the field"]
    #[inline]
    pub fn variant(self, variant: SS4_IO_REQW) -> &'a mut W {
        {
            self.bit(variant._bits())
        }
    }
...
impl R {
    ...
    #[doc = "Bit 8 - SPI Master 0 SS[0] I/O Request"]
    #[inline]
    ...
    #[doc = "Bit 9 - SPI Master 0 SS[1] I/O Request"]
    #[inline]
    ...
    #[doc = "Bit 10 - SPI Master 0 SS[2] I/O Request"]
    #[inline]
    ...
    #[doc = "Bit 11 - SPI Master 0 SS[3] I/O Request"]
    #[inline]
    pub fn ss3_io_req(&self) -> SS3_IO_REQR {
        SS3_IO_REQR::_from({
            const MASK: bool = true;
            const OFFSET: u8 = 11;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[doc = "Bit 12 - SPI Master 0 SS[4] I/O Request"]
    #[inline]
    pub fn ss4_io_req(&self) -> SS4_IO_REQR {
        SS4_IO_REQR::_from({
            const MASK: bool = true;
            const OFFSET: u8 = 12;
            ((self.bits >> OFFSET) & MASK as u32) != 0
...
impl W {
    ...
    #[doc = "Bit 11 - SPI Master 0 SS[3] I/O Request"]
    #[inline]
    pub fn ss3_io_req(&mut self) -> _SS3_IO_REQW {
        _SS3_IO_REQW { w: self }
    }
    #[doc = "Bit 12 - SPI Master 0 SS[4] I/O Request"]
    #[inline]
    pub fn ss4_io_req(&mut self) -> _SS4_IO_REQW {
        _SS4_IO_REQW { w: self }
    }
    #[doc = "Bit 20 - SPI Master 0 Quad I/O Request"]
    #[inline]
