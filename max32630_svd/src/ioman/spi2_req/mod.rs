...
#[doc = "Values that can be written to the field `sr0_io_req`"]
pub enum SR0_IO_REQW {}
impl SR0_IO_REQW {
    #[allow(missing_docs)]
    #[doc(hidden)]
    #[inline]
...
#[doc = r" Proxy"]
pub struct _SR0_IO_REQW<'a> {
    w: &'a mut W,
}
impl<'a> _SR0_IO_REQW<'a> {
    #[doc = r" Writes `variant` to the field"]
    #[inline]
    pub fn variant(self, variant: SR0_IO_REQW) -> &'a mut W {
        {
            self.bit(variant._bits())
        }
    }
...
#[doc = "Values that can be written to the field `sr1_io_req`"]
pub enum SR1_IO_REQW {}
impl SR1_IO_REQW {
    #[allow(missing_docs)]
    #[doc(hidden)]
    #[inline]
...
#[doc = r" Proxy"]
pub struct _SR1_IO_REQW<'a> {
    w: &'a mut W,
}
impl<'a> _SR1_IO_REQW<'a> {
    #[doc = r" Writes `variant` to the field"]
    #[inline]
    pub fn variant(self, variant: SR1_IO_REQW) -> &'a mut W {
        {
            self.bit(variant._bits())
        }
    }
...
impl R {
    ...
    #[doc = "Bit 8 - SPI Master 2 SS[0] I/O Request"]
    #[inline]
    ...
    #[doc = "Bit 9 - SPI Master 2 SS[1] I/O Request"]
    #[inline]
    ...
    #[doc = "Bit 10 - SPI Master 2 SS[2] I/O Request"]
    #[inline]
    ...
    #[doc = "Bit 16 - SPI Master 2 SR[0] I/O Request"]
    #[inline]
    ...
    #[doc = "Bit 17 - SPI Master 2 SR[1] I/O Request"]
    #[inline]
...
impl W {
    ...
    #[doc = "Bit 16 - SPI Master 2 SR[0] I/O Request"]
    #[inline]
    pub fn sr0_io_req(&mut self) -> _SR0_IO_REQW {
        _SR0_IO_REQW { w: self }
    }
    #[doc = "Bit 17 - SPI Master 2 SR[1] I/O Request"]
    #[inline]
    pub fn sr1_io_req(&mut self) -> _SR1_IO_REQW {
        _SR1_IO_REQW { w: self }
    }
    #[doc = "Bit 20 - SPI Master 2 Quad I/O Request"]
    #[inline]
