...
#[doc = "Possible values of the field `vbus_st`"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum VBUS_STR {
    #[doc = r" Reserved"]
    _Reserved(bool),
...
impl VBUS_STR {
    ...
    pub fn bit(&self) -> bool {
        match *self {
            VBUS_STR::_Reserved(bits) => bits,
        }
    }
    #[allow(missing_docs)]
    #[doc(hidden)]
    #[inline]
    pub fn _from(value: bool) -> VBUS_STR {
        match value {
            i => VBUS_STR::_Reserved(i),
        }
    }
}
